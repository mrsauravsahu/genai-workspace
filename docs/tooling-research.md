...
Each harness reads from its own directory. Symlinks and shared files keep one source of truth. See [../README.md](../README.md) for the concrete `.friday/` setup this project uses.
